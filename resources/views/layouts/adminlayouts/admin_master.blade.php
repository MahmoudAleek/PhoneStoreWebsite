...
{{asset('backend')}}
  ...
  <body class="sidebar-fixed sidebar-dark header-light header-fixed" id="body">
    ...
    <div class="wrapper">
          ...
          =====================================
        -->
        @include('layouts.adminlayouts.body.sidebar')

      

      <div class="page-wrapper">

        @include('layouts.adminlayouts.body.header');
  ...
  $(document).ready(function() {
    ...
    if (doughnut !== null) {
      var myDoughnutChart = new Chart(doughnut, {
        type: "doughnut",
        data: {
          labels: ["Samsung", "Samsung", "pending", "canceled"],
          datasets: [
            {
              label: ["Samsung", "Samsung", "pending", "Samsung"],
