        ...
        <ul class="nav sidebar-inner" id="sidebar-menu">
            ...
            <li  class="has-sub active expand" >
              ...
              <ul  class="collapse show"  id="dashboard"
                ...
                <div class="sub-menu">
                      ...
                      <li  class="active" >
                        <a class="sidenav-item-link" href="{{route('home.phone')}}">
                          <span class="nav-text">Home Product</span>
            ...
            <li  class="has-sub" >
              <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#ui-elements"
                ...
                <img src="{{asset('images/icons/gear.png')}}" width="24px" height="24px" style="margin-right: 10px;color:whitesmoke" class="mdi mdi-code-tags" />
